  ...
  const projectData = [
    {
      ...
      image:
        "https://res.cloudinary.com/dzg7eemfm/image/upload/v1740071714/rpehfykjg1rvlblreg8h.png",
      id: 1,
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dzg7eemfm/image/upload/v1740071714/qtq8dsdw3dp9m8onykge.png",
      id: 2,
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dzg7eemfm/image/upload/v1740071714/vhzbojfri4sptnwuh8wa.png",
      id: 3,
    },
  ];
  return (
      ...
      {projectData &&
        projectData.map((data) => {
          return (
            <div
              key={data.id}
              className="flex md:flex-row flex-col w-full md:h-48 gap-4 md:gap-0 rounded-lg p-5 border border-b-4"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {data.tech_stack.map((tech, index) => {
                    return (
                      <div
                        key={index}
                        className="bg-gray-100 text-xs w-fit text-black rounded px-1 py-1"
                      >
                        {tech}
                      </div>
                    );
